...
export const IconSaveAs = (p: IconProps) => (
  <Svg {...p}>
    <path d="M15 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h9l4 4v4" />
...
export const IconReplace = (p: IconProps) => (
  <Svg {...p}>
    <path d="M4 4v6h6" />
    <path d="M20 20v-6h-6" />
...
export const IconWrap = (p: IconProps) => (
  <Svg {...p}>
    <path d="M3 6h18M3 12h13a4 4 0 0 1 0 8h-3M3 18h4" />
...
export const IconMinimap = (p: IconProps) => (
  <Svg {...p}>
    <rect x="3" y="4" width="18" height="16" rx="2" />
    <path d="M16 8h2M16 12h2M16 16h2M6 8h6M6 12h6M6 16h4" />
  </Svg>
);
...
export const IconGoto = (p: IconProps) => (
  <Svg {...p}>
